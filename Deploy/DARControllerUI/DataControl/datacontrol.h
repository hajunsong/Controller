...
#define TIME_LEN                8
#define SERVER_TO_CLIENT_LEN    156

#define OP_MODE_LEN             1
#define SUB_MODE_LEN            1
#define DESIRED_JOINT_LEN       8
#define DESIRED_CARTESIAN_LEN   8
#define MOTION_DATA_LEN         8
#define CLIENT_TO_SERVER_LEM    SOCKET_TOKEN_SIZE + OP_MODE_LEN + JOINT_OP_MODE_LEN + SUB_MODE_LEN + DESIRED_JOINT_LEN*NUM_JOINT + \
    DESIRED_CARTESIAN_LEN*NUM_DOF + SOCKET_TOKEN_SIZE
...
public:
    ...
    enum Section{Ready=0, Side1=1, Side2, Side3, Soup, Rice, Rice1, Rice2, Rice3, Rice4, Rice5, Rice6, Rice7, Rice8, Rice9};
