...
void ControlMain::robotReady()
{
    ...
    path_generator(dataControl->RobotData.present_end_pose[0], dataControl->PathData.point_px[0],
            dataControl->PathData.total_time[1] - dataControl->PathData.total_time[0], dataControl->PathData.acc_time[0], step_size, &dataControl->PathData.readyPath.path_x, 0);
    path_generator(dataControl->RobotData.present_end_pose[1], dataControl->PathData.point_py[0],
            dataControl->PathData.total_time[1] - dataControl->PathData.total_time[0], dataControl->PathData.acc_time[0], step_size, &dataControl->PathData.readyPath.path_y, 0);
    path_generator(dataControl->RobotData.present_end_pose[2], dataControl->PathData.point_pz[0],
            dataControl->PathData.total_time[1] - dataControl->PathData.total_time[0], dataControl->PathData.acc_time[0], step_size, &dataControl->PathData.readyPath.path_z, 0);
    ...
    path_generator(0, theta, dataControl->PathData.total_time[1] - dataControl->PathData.total_time[0], dataControl->PathData.acc_time[0], step_size, &dataControl->PathData.readyPath.path_theta, 0);
