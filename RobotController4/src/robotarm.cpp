...
RobotArm::RobotArm(uint numbody, uint DOF, double step_size, uint8_t ver) {
    num_body = numbody;
    dof = DOF;
    ...
    if(ver == DataControl::Module::FAR_V1){
        // DH paramter
    ...
    else if(ver == DataControl::Module::FAR_V2){
        // DH paramter
        // | Link | alpha(deg) |  a(mm)  |  d(mm)   | theta(deg) |
        // |=====================================================|
        // |  1   |    -90     |  0      |   0      |    -90     |
...
//        body[6].u_vec[0] = 0; body[6].u_vec[1] = 0; body[6].u_vec[2] = 1;
    ...
    else if(ver == DataControl::Module::FAR_V3){
        // DH paramter
        // | Link | alpha(deg) |  a(mm)  |  d(mm)   | theta(deg) |
        // |=====================================================|
        // |  1   |    -90     |  0      |   0      |    -90     |
