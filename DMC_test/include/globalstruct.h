...
const unsigned long int v_global_con_cycle_val[CYCLE_NUMS] = { 0,250000, 500000, 1000000, 2000000, 4000000, 8000000,16000000};
const unsigned long int v_global_con_scycle_val[SCYCLE_NUMS] = { 0, 125000, 250000, 500000, 1000000, 2000000, 4000000, 8000000};
const unsigned long int v_global_con_ref_val[REF_NUMS] = { 0, 1, 2, 4, 8, 10, 16, 20};
...
//};
    ...
    // EtherCAT Slave etries velue end
        ...
        #define ETHERCAT_SLAVE_CLASS_DEBUG 1 // EtherCAT slave debug flag

        //EtherCAT master debug flag
        #define ETHERCAT_MASTER_CLASS_DEBUG_SLAVE_SETTING 1
