...
class ecatslave
{
    private:
        ...
        std::string v_global_vendor_name;
        std::string v_global_slave_models;
    ...
    public :
        ...
        // servo config
        signed long int v_global_run_speed;
        signed long int v_global_run_type;  // Forward, Reverse, Task_Run
    ...
    public:
        ...
        // slave setting
        void f_init_initialize(std::string v_local_slave_models,
