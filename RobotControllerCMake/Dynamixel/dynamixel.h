...
const uint8_t LEN_INDIRECTADDRESS_FOR_READ = LEN_PRESENT_POSITION + LEN_PRESENT_VELOCITY + LEN_PRESENT_CURRENT + LEN_MOVING + LEN_MOVING_STATUS;
...
const uint8_t LEN_INDIRECTADDRESS_FOR_WRITE = LEN_PROFILE_ACCELERATION + LEN_PROFILE_VELOCTIY + LEN_POSITION_P_GAIN;
...
const uint16_t init_pos_p_gain[6] = {900, 900, 900, 800, 800, 800};
